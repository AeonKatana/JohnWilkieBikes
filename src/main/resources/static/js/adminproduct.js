$(document).ready(function(){
 ...
 $(document).ready(function(){
	...
	let v2 = 1;
	// Generate more variation forms
	$("#morevar2").click(function(){
		$("#main2").append(
			'<div id="'+ v2 + '" class="container varo">'
			+ '<div class="text-end"><button type="button" id="b'+ v2 +'" class="btn-close"></button></div><input type="text" id="varname" name="name" class="form-control my-2 varname2"'
			+ 'placeholder="Variation Name">' 
			+ '<label for="price">Product Price</label> '
			+ '<input type="number" id="price" class="form-control prices2" placeholder="0" name="price" required>'
			+ '<label for="stocks">Product Stock</label> <input type="number"'
			+ 'id="stocks" class="form-control stocks2" placeholder="0" name="stock" required>'
			+ '</div>'
		);
		$(".varo button").click(function(){ // X button for generated Variation Forms
			$(this).parent().parent().remove();
